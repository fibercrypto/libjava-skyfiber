...
public class coin__SignedBlock {
  ...
  public void set_unnamed(coin__Block value) {
    skycoinJNI.set_coin__SignedBlock__unnamed(swigCPtr, this, coin__Block.getCPtr(value), value);
  }

  public coin__Block get_unnamed() {
    long cPtr = skycoinJNI.get_coin__SignedBlock__unnamed(swigCPtr, this);
    return (cPtr == 0) ? null : new coin__Block(cPtr, false);
  }

  public void setSig(SWIGTYPE_p_GoUint8_ value) {
    skycoinJNI.set_coin__SignedBlock_Sig(swigCPtr, this, SWIGTYPE_p_GoUint8_.getCPtr(value));
  }

  public SWIGTYPE_p_GoUint8_ getSig() {
    long cPtr = skycoinJNI.get_coin__SignedBlock_Sig(swigCPtr, this);
