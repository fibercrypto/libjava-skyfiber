...
public class wallet__Entry {
  ...
  public void setAddress(cipher__Address value) {
    skycoinJNI.set_wallet__Entry_Address(swigCPtr, this, cipher__Address.getCPtr(value), value);
  }

  public cipher__Address getAddress() {
    long cPtr = skycoinJNI.get_wallet__Entry_Address(swigCPtr, this);
    return (cPtr == 0) ? null : new cipher__Address(cPtr, false);
  }

  public void setPublic(SWIGTYPE_p_GoUint8_ value) {
    skycoinJNI.set_wallet__Entry_Public(swigCPtr, this, SWIGTYPE_p_GoUint8_.getCPtr(value));
  }

  public SWIGTYPE_p_GoUint8_ getPublic() {
    long cPtr = skycoinJNI.get_wallet__Entry_Public(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_GoUint8_(cPtr, false);
  }

  public void setSecret(SWIGTYPE_p_GoUint8_ value) {
    skycoinJNI.set_wallet__Entry_Secret(swigCPtr, this, SWIGTYPE_p_GoUint8_.getCPtr(value));
  }

  public SWIGTYPE_p_GoUint8_ getSecret() {
    long cPtr = skycoinJNI.get_wallet__Entry_Secret(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_GoUint8_(cPtr, false);
  }
