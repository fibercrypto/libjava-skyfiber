...
public class coin__Block {
  ...
  public void setHead(coin__BlockHeader value) {
    skycoinJNI.set_coin__Block_Head(swigCPtr, this, coin__BlockHeader.getCPtr(value), value);
  }

  public coin__BlockHeader getHead() {
    long cPtr = skycoinJNI.get_coin__Block_Head(swigCPtr, this);
    return (cPtr == 0) ? null : new coin__BlockHeader(cPtr, false);
  }

  public void setBody(coin__BlockBody value) {
    skycoinJNI.set_coin__Block_Body(swigCPtr, this, coin__BlockBody.getCPtr(value), value);
  }

  public coin__BlockBody getBody() {
    long cPtr = skycoinJNI.get_coin__Block_Body(swigCPtr, this);
