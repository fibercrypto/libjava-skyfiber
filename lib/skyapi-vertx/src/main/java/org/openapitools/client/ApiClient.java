...
public class ApiClient {
    ...
    private String basePath = "http://127.0.0.1:6420";
    ...
    public ApiClient(Vertx vertx, JsonObject config) {
        ...
        authentications.put("csrfAuth", new ApiKeyAuth("header", "X-CSRF-TOKEN"));
    ...
    protected WebClient buildWebClient(Vertx vertx, JsonObject config) {
        ...
        if (!config.containsKey("userAgent")) {
            config.put("userAgent", "OpenAPI-Generator/0.27.0/java");
        }
