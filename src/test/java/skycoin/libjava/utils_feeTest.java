...
//    }
    ...
    public void TestVerifyTransactionFee() {
      ...
      //      err = SKY_fee_VerifyTransactionFee(empty, utils.toBigInteger(0),
      //      2); assertEquals(err, SKY_ErrTxnNoFee);
      //
      //      // A txn with no outputs hours but with a coinhours burn fee is
      //      valid err = SKY_fee_VerifyTransactionFee(empty,
      //      utils.toBigInteger(100), 2); assertEquals(err, SKY_OK);
      ...
      //      assertEquals(err, 0);
      //      err = SKY_coin_Transaction_PushOutput(txn, addr,
      //      utils.toBigInteger(0),
      ...
      //      assertEquals(err, SKY_OK);
      //      assertEquals(GoUint64Ptr_value(hours),
      //      utils.toBigInteger(4000000));
      //
      ...
      //      err = SKY_coin_Transaction_OutputHours(txn, hours);
      //      assertEquals(err, SKY_OK);
      //      err = SKY_fee_VerifyTransactionFee(txn, GoUint64Ptr_value(hours),
      //      2); assertEquals(err, SKY_OK); err =
      //      SKY_coin_Transaction_OutputHours(txn, hours); assertEquals(err,
      //      SKY_OK); err = SKY_fee_VerifyTransactionFee(
      //          txn,
      //          (GoUint64Ptr_value(hours).multiply(utils.toBigInteger(10))),
      //          2);
      //      assertEquals(err, SKY_OK);
      //
      //      // fee + hours overflows
      ...
      //      err = SKY_fee_VerifyTransactionFee(txn, utils.toBigInteger(10),
      //      2); assertEquals("SKY_fee_VerifyTransactionFee failed", err,
      ...
      //        err =
      //            SKY_coin_Transaction_PushOutput(txn, addr,
      //            utils.toBigInteger(0),
